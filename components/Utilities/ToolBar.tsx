      ...
      >
        ...
        <Link href="/#contact-me">
          <button
            ...
            className="relative hidden lg:inline-flex items-center justify-start px-5 py-1 overflow-hidden font-semibold transition-all bg-white/20 rounded hover:bg-black group"
          >
            ...
            <span className="relative w-full text-lg text-left transition-colors duration-300 ease-in-out flex gap-2 items-center">
              <BsChatRight /> Hire me
            </span>
          </button>
        </Link>
